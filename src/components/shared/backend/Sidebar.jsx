            ...
            <div className="sidebar-content js-simplebar">
                ...
                <ul className="sidebar-nav">
                    ...
                    <li className="sidebar-item">
                        <NavLink to="/backend/dashboard" className="sidebar-link" activeStyle={{ fontWeight: "bold", color: "yellow" }}>
                            <i
                    ...
                    <li className="sidebar-item">
                        ...
                        >
                            <li className="sidebar-item">
                                <NavLink to="/backend/product" className="sidebar-link" activeStyle={{ fontWeight: "bold", color: "yellow" }}>
                                    Product
                                </NavLink>
                            </li>
                            <li className="sidebar-item">
