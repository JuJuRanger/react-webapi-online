...
const Navbar = () => {
    // เอาค่าจาก local storage ที่ล็อคอินส่งเข้ามา key คือ fullname
    let fullnameLocalStorage = localStorage.getItem('fullname')

    // ลบค่า local storage ทำ logout โดยทำแบบสร้าง event function ขึ้นมา
                    ...
                    <li className="nav-item dropdown">
                        ...
                        >
                            <img
                                ...
                                alt={fullnameLocalStorage}
                            />{" "}
                            <span className="text-dark">{fullnameLocalStorage}</span>
                        </a>
